  ...
  return (
    <div>
      ...
      <div className="max-w-4xl">
        <Paragraph className="leading-loose mt-4">
          Hey there, I&apos;m <b>Mayowa Obisesan</b>
          <br />
          Nickname: amtheblessed
          <br />
          I Love tech and I&apos;m a versatile Software Engineer that build daily.
        </Paragraph>
        <Paragraph className="font-bold leading-relaxed mt-4">
        ...
        <Paragraph className="leading-relaxed mt-4">
