  ...
  return (
    <div>
      ...
      <div className="max-w-4xl">
        ...
        <Paragraph className=" mt-4">
          My Philosophy is simple, what can be made simple, should not be made unnecessarily Complex.
        </Paragraph>

        <Paragraph className="mt-12">
          I&apos;ve built more than 30 different personal side-projects, most of which I used for up-skilling and generally learning new frameworks, languages and tools.
        </Paragraph>

        <Paragraph className=" mt-4">
          But the completed projects I added to this portfolio are my completed 2025 projects, there are about 4 more that are WIP. So yeah.
          This is how I&apos;m quite versatile in building for web, mobile, blockchain and AI and a bit of coding in C# for Unity games as well (Just a bit though).
        </Paragraph>
        <Paragraph className=" mt-4">
          I&apos;m proficient in Systems Programming, but I currently focus on web dev (from Backend, to Frontend and everything in between).
        </Paragraph>
        <Paragraph className=" mt-4">
          What sets me apart is my unwavering appreciation for beauty and usability. I believe
          ...
          <br />
          If you check all these projects in this portfolio. They are beautiful, functional and have world-class User Experience.
          I love beautiful UI and Amazing UX and DX.
        </Paragraph>
        <Paragraph className=" mt-4">
          ...
          who loves to talk about tech, and appreciates the finer aspects of design and building products that people will use, there&apos;s something
          here for you.
        </Paragraph>
        <Paragraph className=" mt-4">
        ...
        <Paragraph className=" mt-4">
          Chat me up if you want to talk about tech or you have a product to build and want my honest opinion.
          <br/>
          Thank you for being here. I&apos;m excited to connect with you. 🫡✌🏼
        </Paragraph>
      </div>
    </div>
  );
